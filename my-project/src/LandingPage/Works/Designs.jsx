    ...
    <div className="relative">
      ...
      <div className="relative-container ">
        ...
        <div className="max-w-screen-xl px-4 mx-auto grid gap-4 md:gap-8 md:grid-cols-3">
          {[
            { src: "/Images/DesignImages/karmine2.png", alt: "Karmine", title: "Karmine" },
            { src: "/Images/DesignImages/plant2.png", alt: "Oasis", title: "Oasis" },
            { src: "/Images/DesignImages/LoyaltyTXT.png", alt: "LoyaltyTXT", title: "LoyaltyTXT" },
            { src: "/Images/DesignImages/Swiss.png", alt: "Switzerland", title: "Exploring Switzerland" },
            { src: "/Images/DesignImages/CB.png", alt: "CB", title: "CyberRebirth" },
            { src: "/Images/DesignImages/Astoria.png", alt: "Astoria", title: "Hotel Astoria" },
            { src: "/Images/DesignImages/DH.png", alt: "DisputeHelp", title: "DisputeHelp" },
            { src: "/Images/DesignImages/PizzaPlace.png", alt: "PizzaPlace", title: "That Pizza Place" },
            { src: "/Images/DesignImages/juice2.png", alt: "Juice", title: "JuiceLabs" },
            { src: "/Images/DesignImages/car2.png", alt: "Luminaire", title: "Luminaire" },
            { src: "/Images/DesignImages/lux.png", alt: "Lux", title: "LuxWatch" },
            { src: "/Images/DesignImages/Urban.png", alt: "UrbanVibe", title: "UrbanVibe" },
          ].map((image, index) => (
            <div 
              key={index} 
