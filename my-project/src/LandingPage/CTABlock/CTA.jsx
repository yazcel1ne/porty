...
const TechUsed = () => {
  return (
    <>
      <div class="max-w-screen-xl px-4 mx-auto grid gap-8 md:grid-cols-1">
        <div class="bg-purpbg p-16 flex flex-col justify-center items-center text-white mb-4 md:flex md:items-left md:justify-left border border-gradient-a">
