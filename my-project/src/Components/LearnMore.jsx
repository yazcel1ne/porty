...
const LearnMore = () => {
  return (
    <div class="relative">
      ...
      <button class="inline-flex items-center mt-6 border-0 border-white hover:border-purple-400 from-white to-white hover:bg-BB96F6 text-purple-400 hover:text-white font-raleway font-semibold py-2 rounded-[24px] mr-4">
        LEARN MORE
        <svg
